...
<html lang="en">
  <head>
    <title>BaliRattanBag | About </title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="<?php echo base_url('assets/images/rattanbag.png')?>" alt="Image placeholder" class="img-fluid rounded">
          ...
          <div class="col-md-5">
            ...
            <div class="site-section-heading pt-3 mb-4">
              <h2 class="text-black">Bali Rattan Bag</h2>
            </div>
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo base_url('assets/images/person_1.jpg')?>" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo base_url('assets/images/person_2.jpg')?>" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo base_url('assets/images/person_3.jpg')?>" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="<?php echo base_url('assets/images/person_4.jpg')?>" alt="Image placeholder" class="mb-4">
